...
Only 1 of 31 hand-written Go files in this repo has a test today
(`pkg/sound/service_test.go`) — 31 = 35 total `.go` files outside
`web/speakerbob/`, minus the 4 generated `zz_*_provider.go` files. The agreed policy for this modernization
